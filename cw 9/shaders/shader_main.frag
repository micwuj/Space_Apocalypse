...
void main()
{
    ...
    //lightPlace
    vec3 lightPlaceDir = normalize(lightPlaceDirTS);
    attenuatedlightColor = lightColor/pow(length(lightPlacePos-worldPos),2);
	ilumination=ilumination+PBRLight(lightPlaceDir,attenuatedlightColor,normal,viewDir);
